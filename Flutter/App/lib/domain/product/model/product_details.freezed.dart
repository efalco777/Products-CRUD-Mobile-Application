...
class _$ProductDetailsImpl implements _ProductDetails {
  ...
  @override
  String toString() {
    return 'ProductDetails(id: $id, title: $title, description: $description, price: $price, category: $category, images: $images)';
  }
...
abstract class _ProductDetails implements ProductDetails {
  const factory _ProductDetails(
      ...
      required final List<String> images}) = _$ProductDetailsImpl;
